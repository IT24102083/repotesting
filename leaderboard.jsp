...
<body>
    ...
    <!-- User badge with current user information -->
    <div class="user-badge" id="currentUser">
        <img src="<c:out value='${sessionScope.user.profileImage}' default='./assets/images/student/default.jpg'/>" alt="Student" class="user-avatar">
        ...
        <div class="leaderboard-header">
            <div class="container">
                ...
                <p class="leaderboard-subtitle animate__animated animate__fadeInUp animate__delay-1s">
                    See how you rank among other students. Track your progress and aim for the top!
                </p>
            </div>
        </div>
                                ...
                                for (int i = 0; i < jsonObjects.length; i++) {
                                    ...
                                    if (totalPoints > 0) {
                                        ...
                                        if (earnedPoints > 0) {
                                            ...
                                            percentage = scoreValue / totalPoints * 100;
                                        }
                                    }
                                    
                                    // Determine passed status based on percentage threshold rather than JSON value
                                    ...
                                    result.setPassed(passed); // Set the passed status based on percentage
                        ...
                        <tbody>
                            <% 
                                ...
                                for (Result result : results) {
                                    ...
                                    // Calculate percentage for display and status determination
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            try {
                ...
                const topRankColors = [
                    'rgba(255, 215, 0, 0.8)',    // Gold for 1st
                    'rgba(192, 192, 192, 0.8)',   // Silver for 2nd
                    'rgba(205, 127, 50, 0.8)'     // Bronze for 3rd
                ];
                
                const topRankBorderColors = [
                    'rgba(255, 215, 0, 1)',
                    'rgba(192, 192, 192, 1)',
                    'rgba(205, 127, 50, 1)'
                ];
                ...
                try {
                    ...
                    for(int i = 0; i < chartLimit; i++) {
                        ...
                        if (<%= i %> < 3) {
                            ...
                            chartData.datasets[0].borderColor.push(topRankBorderColors[<%= i %>]);
                        } else {
                            // Use modulo to cycle through the remaining colors
                            let colorIndex = (<%= i %> - 3) % (vibrantColors.length - 3) + 3;
                            chartData.datasets[0].backgroundColor.push(vibrantColors[colorIndex]);
                            chartData.datasets[0].borderColor.push(vibrantBorderColors[colorIndex]);
                        }
                        <%
                    }
                } catch(Exception e) {
                        ...
                        window.updateChart = function(examId) {
                            ...
                            setTimeout(() => {
                                try {
                                    ...
                                    rows.forEach((row, index) => {
                                        ...
                                        if ((examId === 'all' || rowExamId === examId) && !row.classList.contains('placeholder-row')) {
                                            ...
                                            if (visibleCount < 3) {
                                                ...
                                                filteredBorders.push(topRankBorderColors[visibleCount]);
                                            } else {
                                                // Use modulo to cycle through the remaining colors
                                                const colorIndex = (visibleCount - 3) % (vibrantColors.length - 3) + 3;
                                                filteredColors.push(vibrantColors[colorIndex]);
                                                filteredBorders.push(vibrantBorderColors[colorIndex]);
                                            }
                                    ...
                                    // Apply different legend settings for pie charts
            ...
            document.getElementById('menu-toggle').addEventListener('click', function() {
                ...
                // Hide/show logo text
                document.getElementById('logo').classList.toggle('hiddenlogo');
            });
            
            // Set current user information
            document.getElementById('currentUser').innerHTML = `
                <img src="./assets/images/teacher/default.jpg" alt="User" class="user-avatar">
                <span class="text-muted">IT24102083</span>
            `;
            
            // Set current date and time
            document.getElementById('currentDateTime').querySelector('span').textContent = "2025-05-04 23:23:26";
        });
